  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 md:px-12 py-16 md:py-24 flex flex-col gap-10">
      ...
      <div className="prose prose-slate max-w-none text-slate-600 text-lg space-y-6">
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">1. Free Service</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">2. Acceptable Use of the Service</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">3. Limitation of Liability</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">4. Refund Policy</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">5. Modifications to the Service and Terms</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-10 mb-4">6. Contact Us</h3>
        <p>
